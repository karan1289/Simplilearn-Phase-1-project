...
public class project_phase_1 {
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		String filename;
		char ch;
		File directory = new File("D://java projects//Basics_of_Java//File handling//Project//");
		...
		System.out.println("*****************************************");
		System.out.println("******* Karan Shivsharan *********************");
		System.out.println("*****************************************");
		...
		do {
			...
			case 1:
				...
				filename = input.next();
				try {
					File file = new File("D://java projects//Basics_of_Java//File handling//Project//" + filename + ".txt");
			...
			case 3:
				...
				filename = input.next();
				File directory_delete = new File("D://java projects//Basics_of_Java//File handling//Project");
				...
				if (flist_delete == null) {
					...
					for (int i = 0; i < flist_delete.length; i++) {
						...
						if (delete_filename.equalsIgnoreCase(filename)) {
							File file = new File(
									"D://java projects//Basics_of_Java//File handling//Project//" + delete_filename);
							if (file.delete()) {
			...
			case 4:
				...
				filename = input.next();
				File directory_search = new File("D://java projects//Basics_of_Java//File handling//Project//");
	...
	private static void listOfFiles() {
		...
		File folder = new File("D://java projects//Basics_of_Java//File handling//Project//");
